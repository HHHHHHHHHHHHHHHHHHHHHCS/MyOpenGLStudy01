...
int _03_HelloShard_Practice::DoMain()
{
	...
	Shader ourShader("Shaders/03_HelloWorld_Parctice.vs", "Shaders/03_HelloWorld_Parctice.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.Use();
		ourShader.SetFloat("offset", std::sin(glfwGetTime()) / 2);
